    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
                ...
                <div class="custom-tabs">
                  ...
                  <button onclick="chqStatus()" class="btn btn-primary custom-tab custom-tab-active">Cheques</button>
                ...
                <div id="page1">
                  ...
                  <div class="panel-body custom-body">
                    @include('partials.import.importchqform')
                  </div>
                  <!--div class="panel-body custom-body">
                    @include('partials.import.newchequeform')
                  </div-->
                </div>
            </div>
        </div>
