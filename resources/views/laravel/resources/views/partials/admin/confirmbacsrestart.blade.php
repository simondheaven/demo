<script>
    ...
    function confirmResBacs(){
      document.getElementById('loadinggif').style.opacity = '1';
      window.location.replace('/admin/bacs/restart/{{session('confirmBacsRestart')}}');
    }
</script>
  ...
  <div class="col-md-12 col-md-offset-0">
    ...
    <div class="modal-footer">
      <img id="loadinggif" src="/img/loading.gif" style="margin-right:15px; opacity:0;">
        ...
        <button class="btn btn-primary custom-btn-submit" onclick="confirmResBacs()" data-dismiss="modal">Confirm</button>
    </div>
  </div>
</div>
</div>
