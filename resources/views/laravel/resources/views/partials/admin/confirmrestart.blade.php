<script>
    ...
    function confirmRes(){
      ...
      window.location.replace('/admin/import/restart/{{session('confirmRestart')}}');
      setTimeout(function(){
        confirmRes();
      }, 20000);
    }
  ...
  <div class="col-md-12 col-md-offset-0">
    ...
    <div class="modal-footer">
      <img id="loadinggif" src="/img/loading.gif" style="margin-right:15px; opacity:0;">
        ...
        <button class="btn btn-primary custom-btn-submit" onclick="confirmRes()" data-dismiss="modal">Confirm</button>
    </div>
  </div>
</div>
</div>
