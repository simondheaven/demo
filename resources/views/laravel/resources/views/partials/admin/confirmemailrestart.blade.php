<script>
    ...
    function confirmResEm(){
      document.getElementById('loadinggif').style.opacity = '1';
      window.location.replace('/admin/email/restart/{{session('confirmEmailRestart')}}');
    }
</script>
  ...
  <div class="col-md-12 col-md-offset-0">
    <div class="panel panel-default">
      <div class="panel-heading custom-heading">
        ...
        Confirm Bounced Email Import Restart
      </div>
    ...
    <div class="modal-footer">
      <img id="loadinggif" src="/img/loading.gif" style="margin-right:15px; opacity:0;">
        ...
        <button class="btn btn-primary custom-btn-submit" onclick="confirmResEm()" data-dismiss="modal">Confirm</button>
    </div>
  </div>
</div>
</div>
