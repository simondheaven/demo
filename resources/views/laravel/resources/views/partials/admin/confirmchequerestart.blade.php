<script>
    ...
    function confirmResCh(){
      ...
      window.location.replace('/admin/cheque/restart/{{session('confirmChequeRestart')}}');
    }
</script>
  ...
  <div class="col-md-12 col-md-offset-0">
    <div class="panel panel-default">
      <div class="panel-heading custom-heading">
        ...
        Confirm Cheque Status Import Restart
      </div>
    ...
    <div class="modal-footer">
      <img id="loadinggif" src="/img/loading.gif" style="margin-right:15px; opacity:0;">
        ...
        <button class="btn btn-primary custom-btn-submit" onclick="confirmResCh()" data-dismiss="modal">Confirm</button>
    </div>
  </div>
</div>
</div>
