...
<div id="tablepanel" class="panel panel-default" style="opacity:0">
    ...
    function populateTable(){
      ...
      <?php
        ...
        foreach($custs as $cust){
          ...
          echo $cust->first_name.' '.$cust->surname;
          echo '</a>';
          echo '"';
          echo ',';
          foreach($cust->toArray() as $key => $val){
      ...
      document.getElementById('callloader').style.display="none";
      document.getElementById('resultTable').style.display="table";
      document.getElementById('tablepanel').style.opacity = 1;
      t.draw(false);
    }
    </script>
    <script>
